	  	...
	  	<header id="header" class="big with-separation-bottom">
	  		...
	  		<div id="top-navigation">
		  		<ul class="animate-me fadeInDown" data-wow-duration="1.2s">
			  		<li class="menu-item"><i class="fa fa-phone"></i>+91-9859658965,+91-2563569856</li>
	  		...
	  		<nav id="navigation">
		  		...
		  		<ul id="left-navigation" class="animate-me fadeInLeftBig">
			  		...
			  		<li class="menu-item menu-item-has-children">
			  			<a href="" data-description="The Previous One's">PREVIOUS RESULTS</a>
			  		</li>
		  		...
		  		<ul id="right-navigation" class="animate-me fadeInRightBig">
			  		<li class="menu-item"><a href="admin/index.php" data-description="Our Art and Work">ADMIN</a></li>
			  		<li class="menu-item"><a href="index.php" data-description="Let's get in touch">VOTER</a></li>
		  		</ul>
	  		</nav>

	  		<!-- TEXT SLIDER -->
			<div id="ticker" class="animate-me zoomIn">
				<h2 class="with-breaker">Why choose us ?</h2>
				<div id="ticker-text">
					<ul>
						<li>Vote From Home</li>
						<li>Save Time</li>
						<li>Save transportation fees</li>
						<li>Vote From Anywhere</li>
						<li>No need to Stand in que</li>
						<li>We're dynamic !</li>
						<li>Feel Secured </li>
					</ul>
				</div>
	  		...
	  		<div id="scroll-bottom" class="animate-me fadeInUpBig">
		  		<a href="#"><b>IN BRIEF</b><br><i class="fa fa-angle-double-down"></i></a>
	  		</div>
	  		...
	  		<div class="container">
                ...
                <!-- ABOUT -->
	  			<h2 class="with-breaker animate-me fadeInUp">
		  			Our Idea<span>Yep, It rocks !</span>
	  			</h2>
	  			<div class="row">
	  				<div class="col-md-8">
	  					<h3>"STARRY"   Online Voting System</h3>
	  					<p class="text-justify"><span class="dropcap">"S</span>tarry  ,Online Voting enables voters to cast their vote privately and easily from any location and on any device with Internet access (PC, tablet, smartphone, etc.), ensuring maximum election engagement by enabling remote and disabled voters to participate on equal terms.
		  			...
		  			<div class="col-md-4">
		  				...
		  				<blockquote>We believe in a Better Future for developing India.Giving Votes to a Person and making him Win is Like giving him Our Life..So Vote For A Better India .
                       .</blockquote>
		  			</div>
	  			</div>
	  		...
	  		<section class="contact-container with-separation-bottom with-separation-top">
		  		<div class="contact-boxes">
		  			<div class="contact-box contact-box-email animate-me zoomIn">
		  				...
		  				<h5>Email:starryautomatedvoting@gmail.com</h5>
                        		  			</div>
		  			<div class="contact-box contact-box-twitter animate-me zoomIn">
		  				<h2>Twitter</h2>
		  				<p>Follow us to interact, chat and share Your new ideas on Twitter.</p>
		  				<a href="https://twitter.com/VotingStarry" class="btn btn-default"><i class="fa fa-twitter"></i> Follow us</a>
		  			</div>
		  			<div class="contact-box contact-box-facebook animate-me zoomIn">
		  				...
		  				<a href="https://www.facebook.com/starry.starry.9212" class="btn btn-default"><i class="fa fa-facebook"></i> Like Our Page</a>
		  			</div>
		  		...
		  		<div class="row">
			  		...
			  		<div class="col-md-4 widget animate-me fadeInRight">
			  			...
			  			<ul class="contact-informations">
				  			<li class="contact-address">R. N. Shetty Polytechnic Department of Computer Science,Belgaum (Karnataka) - 590001</li>
