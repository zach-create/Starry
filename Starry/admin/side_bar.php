            ...
            <ul class="nav navbar-top-links navbar-right">
			 ...
			 ?>
                ...
                <li class="dropdown">
					...
					<i class="fa fa-cog fa-spin fa-fw"></i>Welcome: Dear Voter <?php echo $user_username = $user_row['firstname']." ".$user_row['lastname'];?>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<a href="#"><i class="fa fa-user fa-fw"></i> Publish Results<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="user.php"> <i class = "fa fa-users" ></i> Publish on to Voters Screen</a>
                                </li>
						</li>
